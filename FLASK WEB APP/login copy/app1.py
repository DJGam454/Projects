...
def index():
    if 'username' in session:
        # CNN Page link
        return redirect("https://03cc-49-36-181-177.ngrok-free.app ")  # Redirect to the plant disease app
...
def login():
    if request.method == 'POST':
        ...
        if user and check_password_hash(user.password, password):
            ...
            return redirect("https://03cc-49-36-181-177.ngrok-free.app ")  # Redirect after successful login
        else:
